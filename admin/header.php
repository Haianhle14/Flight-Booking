        ...
        <li class="nav-item">
          <div class="dropdown mt-2">
            <button class="btn bg-transparent dropdown-toggle text-white" type="button" 
              ...
              <i class="fa fa-cogs text-white"></i> Quản lý
            </button>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="list_airlines.php">Quản lý máy bay</a>
              <a class="dropdown-item" href="all_users.php">Quản lý khách hàng</a>
            </div>
          </div>  
        </li>
        <!-- Thêm máy bay -->
          ...
          <div class="dropdown mt-2">
            <button class="btn bg-transparent dropdown-toggle text-white" type="button" 
              id="dropdownMenuButton2" data-toggle="dropdown" 
                aria-haspopup="true" aria-expanded="false">
              <i class="fa fa-plus text-white"></i> Thêm máy bay
            </button>  
            <div class="dropdown-menu">
